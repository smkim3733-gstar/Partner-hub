...
- 최신 기능 커밋: `2fb858f4f020eaee298e863ae2440aaf0ef9be9a` (`fix: bind ChatGPT identity to member`)
- 최신 기능: ChatGPT 안정 사용자 ID의 단방향 해시를 회원 ID에 1:1 결속해 동일 이메일이 다른 계정에 재할당돼도 기존 회원 접근을 넘기지 않음. 신규 가입 원자적 결속, 기존 활성 회원 최초 접속 결속, 이메일 변경·회원 삭제 원자적 해제와 정지 보존 포함
- 검증: Node 회귀 검사 482개, 격리 workerd/D1/R2 검사 170개, 타입검사, 전체 lint, 변경 파일 형식검사, 프로덕션 빌드와 로컬 운영 Worker 응답 확인 통과
...
- 최신 Sites 저장 버전: 115 (`appgprj_6a92514801988191b79eb9bd314e3fcd~appgver_829edf6ab8288191ac057a1e14d508f8`), 소스 `2fb858f4f020eaee298e863ae2440aaf0ef9be9a`
- 운영 상태: 서버 오류 로그 개인정보 보완본 버전 107이 공개 운영 중이다. 버전 108~114는 버전 115로 대체해 배포하지 않으며, ChatGPT 안정 ID-회원 결속 보완본 버전 115가 공개 배포 승인 대기 중이다.
...
Sites 버전 115 저장·검증까지 완료했고 공개 운영본은 버전 107이다. 버전 115 공개 배포에는 사용자 명시 승인이 필요하다. 승인·배포 점검 여부와 관계없이 30분 간격 자동 개발이 다음 고우선순위 운영 감사를 이어간다. 실제 파트너 계정·고객 데이터·외부 발송·유료 AI·보관 및 삭제 정책은 별도 승인 없이 사용하거나 변경하지 않는다.
