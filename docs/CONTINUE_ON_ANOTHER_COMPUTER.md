...
- 최신 기능 커밋: `e4b90d8c7ad6ecb93e6fdcc011a5d49a6d462f59` (`fix: recheck intake source races`)
- 최신 확인: 신청자료 원본 R2 읽기·문서 해석·SHA-256 계산 중 사건 삭제, 담당 재배정, 같은 크기 원본 교체
- 연속 확인: 미리보기 404, 가져오기 403, 원본 무결성 409 차단과 새 FLOW 예약·복사 객체·D1 쓰기 0건
...
- 현재 공개 운영본: 버전 107
- 최신 Sites 저장 버전: 304 (`appgprj_6a92514801988191b79eb9bd314e3fcd~appgver_5f8c18f8648081919ce88539469e679e`), 소스 `e4b90d8c7ad6ecb93e6fdcc011a5d49a6d462f59`
- 운영 상태: 서버 오류 로그 개인정보 보완본 버전 107이 공개 운영 중이다. 버전 108–303은 더 완전한 후보인 버전 304로 대체한다.
...
먼저 [상담 FLOW 신청자료 원본 읽기·해시 경쟁 무결성](FLOW_INTAKE_SOURCE_READ_RACE_INTEGRITY_2026_09_07.md)을 확인한다.
...
Sites 버전 304 저장·검증까지 완료했고 공개 운영본은 버전 107이다. 버전 108–303은 버전 304로 대체해 배포하지 않는다. 공개 교체는 정확한 `버전 304 운영 배포 승인`이 필요하다. 30분 간격 자동 개발은 활성 상태로 신청자료 원본 검증 직후부터 FLOW 예약·복사 사이의 원본 삭제·교체 경쟁을 다음 순서로 감사한다. 실제 파트너 계정·고객 데이터·외부 발송·유료 AI는 별도 승인 없이 사용하지 않는다.
