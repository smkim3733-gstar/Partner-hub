...
| [v343 개발 마감 보고서](V343_FINAL_DEVELOPMENT_REPORT_2026_09_08.md)                                                 | 전체 구현·보안·검증·공개 운영 배포·수용 잔여 위험 최종 정리                              |
...
| [파일 재고 FLOW 영수증 전체 필드 봉투](FILE_INVENTORY_FLOW_RECEIPT_FIELD_ENVELOPE_2026_09_08.md)                     | 의미 필드 쌍·타입·허용 키 봉투 결속과 R2 전 차단                                         |
| [파일 재고 FLOW 레거시 영수증 대상 봉투](FILE_INVENTORY_FLOW_LEGACY_RECEIPT_TARGET_ENVELOPE_2026_09_08.md)           | 레거시 영수증 targetId 주입 격리와 R2 전 차단                                            |
| [파일 재고 FLOW 영수증 대상 봉투 결속](FILE_INVENTORY_FLOW_RECEIPT_TARGET_ENVELOPE_2026_09_08.md)                    | action별 targetId 필수·금지 봉투 결속과 R2 전 차단                                       |
| [파일 재고 FLOW 영수증 감사시각 결속](FILE_INVENTORY_FLOW_RECEIPT_AUDIT_TIME_BINDING_2026_09_08.md)                  | 현대 영수증 감사시각과 완료 예약·파일 생성시각 결속·R2 전 차단                           |
| [파일 재고 FLOW 계약 영수증 대상 결속](FILE_INVENTORY_FLOW_CONTRACT_RECEIPT_TARGET_BINDING_2026_09_08.md)            | record_contract 영수증 회의·계약 회의·서명본 파일 결속·R2 전 차단                        |
| [파일 재고 FLOW 요청서류 영수증 대상 결속](FILE_INVENTORY_FLOW_DOCUMENT_RECEIPT_TARGET_BINDING_2026_09_08.md)        | receive_document 영수증 대상 요청과 실제 fileId 결속·R2 전 차단                          |
| [파일 재고 FLOW 전사문 영수증 대상 결속](FILE_INVENTORY_FLOW_TRANSCRIPT_RECEIPT_TARGET_BINDING_2026_09_08.md)        | save_transcript 영수증 대상 녹취와 transcriptFileId 결속·R2 전 차단                      |
| [파일 재고 FLOW 녹취 영수증 대상 결속](FILE_INVENTORY_FLOW_RECORDING_RECEIPT_TARGET_BINDING_2026_09_08.md)           | save_recording file/audio 슬롯과 명령 기반 녹취 대상 결속·R2 전 차단                     |
| [파일 재고 FLOW 보고서 영수증 대상 결속](FILE_INVENTORY_FLOW_REPORT_RECEIPT_TARGET_BINDING_2026_09_08.md)            | save_report 영수증과 명령 기반 보고서의 실제 첨부 파일 결속·R2 전 차단                   |
| [파일 재고 FLOW 신청자료 영수증 출처 결속](FILE_INVENTORY_FLOW_INTAKE_RECEIPT_PROVENANCE_2026_09_08.md)              | save_source/import_intake_source와 신청 원본 출처 증빙 양방향 결속                       |
| [파일 재고 FLOW 업로드 영수증 목적·슬롯 결속](FILE_INVENTORY_FLOW_UPLOAD_RECEIPT_SEMANTICS_2026_09_08.md)            | 영수증·감사 action과 실제 예약 purpose·slot 결속·R2 전 차단                              |
| [파일 재고 FLOW 영수증 의미 결속](FILE_INVENTORY_FLOW_RECEIPT_SEMANTIC_BINDING_2026_09_08.md)                        | 새 형식 영수증 actor·action과 동일 명령 감사기록 결속·R2 전 차단                         |
| [파일 재고 FLOW 영수증 행위자·지문 결속](FILE_INVENTORY_FLOW_RECEIPT_IDENTITY_BINDING_2026_09_08.md)                 | payload 영수증 actorKey·fingerprint와 예약 원장의 정확 결속·R2 전 차단                   |
| [파일 재고 FLOW 한쪽 완료 영수증 격리](FILE_INVENTORY_FLOW_PARTIAL_RECEIPT_LEDGERS_2026_09_08.md)                    | ready 예약만/완료 영수증만 남은 완료 파일의 증명 제외·R2 전 차단                         |
| [파일 재고 FLOW 부분 완료 pending 격리](FILE_INVENTORY_FLOW_PENDING_OWNER_QUARANTINE_2026_09_07.md)                  | 소유 원장과 함께 남은 pending 예약의 inconsistent 격리, 정상 pending-only 유지           |
| [파일 재고 FLOW 완료 예약·영수증 결속 무결성](FILE_INVENTORY_FLOW_RECEIPT_BINDING_INTEGRITY_2026_09_07.md)           | ready 예약·완료 영수증과 소유·payload 증명의 정확 결속, 손상 시 R2 전 격리               |
| [파일 재고 FLOW 완료 예약·영수증 고아 기록 가시성](FILE_INVENTORY_FLOW_ORPHAN_RECEIPT_VISIBILITY_2026_09_07.md)      | ready 예약·완료 영수증만 남은 파일의 단일 격리·증명 불가 집계·R2 전 차단                 |
| [관리자 파일 재고 증명 원장 결속 무결성](FILE_INVENTORY_PROOF_LEDGER_BINDING_2026_09_07.md)                          | MIME·저장 키·FLOW payload 결속 검증, 손상·고아 원장의 증명 과대 집계 차단                |
| [관리자 파일 재고 단일 D1 스냅샷 일관성](FILE_INVENTORY_SNAPSHOT_CONSISTENCY_2026_09_07.md)                          | 목록·체크섬 현황의 단일 SQLite 읽기, 동시 원장 추가 시 시점 혼합 차단                    |
| [관리자 파일 재고 체크섬 적용 현황](FILE_INVENTORY_CHECKSUM_COVERAGE_2026_09_07.md)                                  | SHA-256·레거시 증명 건수, 개별 적용 유형과 비밀값·R2 본문 비노출                         |
...
| [상담 FLOW R2 저장 실패 중 접근변경 경쟁](FLOW_R2_WRITE_FAILURE_ACCESS_RACE_2026_09_07.md)                           | 저장 실패 뒤 접근 재검사·객체 생성 전/후 결과·pending 예약·정확 재시도                   |
...
| [상담 FLOW 사건 삭제 시점별 경쟁](FLOW_CASE_DELETION_TIMING_RACE_2026_09_07.md)                                      | 본문·R2 시점 사건 삭제 404 재검사·객체/예약 보존·복구 후 동일 예약 완료                  |
| [상담 FLOW 본문 처리 중 사건·담당 계정 삭제 경쟁](FLOW_BODY_CASE_MEMBER_DELETION_RACE_2026_09_07.md)                 | 관리자 2단계 삭제·결속 폐기·R2 전 차단·기존 객체와 예약 보존·복구 후 재결속              |
| [상담 FLOW R2 쓰기 중 사건·담당 계정 삭제 경쟁](FLOW_R2_CASE_MEMBER_DELETION_RACE_2026_09_07.md)                     | 관리자 2단계 삭제·결속 폐기·객체와 예약 보존·복구 후 재결속                              |
| [상담 FLOW D1 쓰기 직전 사건·담당 계정 삭제 경쟁](FLOW_D1_CASE_MEMBER_DELETION_RACE_2026_09_07.md)                   | 관리자 2단계 삭제·결속 폐기·stale D1 차단·복구 후 재결속                                 |
| [상담 FLOW D1 쓰기 직전 사건 삭제 경쟁](FLOW_RETRY_D1_WRITE_CASE_DELETION_RACE_INTEGRITY_2026_09_07.md)              | 실제 관리자 삭제·stale D1 차단·객체와 예약 보존·사건 복구 후 완료                        |
| [상담 FLOW D1 쓰기 직전 담당 계정 변경 경쟁](FLOW_RETRY_D1_WRITE_ASSIGNMENT_RACE_INTEGRITY_2026_09_07.md)            | 동일 표시명 안정 ID 판정·stale D1 차단·객체와 예약 보존·담당 복구 후 완료                |
| [상담 FLOW D1 쓰기 직전 표시명 변경 경쟁](FLOW_RETRY_D1_WRITE_DISPLAY_NAME_RACE_INTEGRITY_2026_09_07.md)             | 안정 ID 결속·변경 프로필 유지·stale D1 차단·기존 상담 표시 보존                          |
| [상담 FLOW D1 쓰기 직전 로그인 이메일 변경 경쟁](FLOW_RETRY_D1_WRITE_EMAIL_CHANGE_RACE_INTEGRITY_2026_09_07.md)      | 신원 결속 폐기·상태 CAS·stale D1 차단·안정 ID 재결속 후 동일 예약 완료                   |
