...
export const companyFileObjectChecksumsTableSql = `
...
export const companyFileObjectChecksumsNoUpdateTriggerSql =
  "CREATE TRIGGER IF NOT EXISTS company_file_object_checksums_no_update BEFORE UPDATE ON company_file_object_checksums BEGIN SELECT RAISE(ABORT, 'company file object checksum is immutable'); END";

export const companyFileObjectChecksumsNoDirectDeleteTriggerSql =
  "CREATE TRIGGER IF NOT EXISTS company_file_object_checksums_no_direct_delete BEFORE DELETE ON company_file_object_checksums WHEN EXISTS (SELECT 1 FROM company_file_objects WHERE id = OLD.file_id) BEGIN SELECT RAISE(ABORT, 'company file object checksum requires parent deletion'); END";
...
export const consultingFlowsSaveTranscriptTargetTriggerSql = `
...
export const consultingFlowFileObjectChecksumsTableSql = `
...
export const consultingFlowFileObjectChecksumsNoUpdateTriggerSql =
  "CREATE TRIGGER IF NOT EXISTS consulting_flow_file_object_checksums_no_update BEFORE UPDATE ON consulting_flow_file_object_checksums BEGIN SELECT RAISE(ABORT, 'consulting flow file object checksum is immutable'); END";

export const consultingFlowFileObjectChecksumsNoDeleteTriggerSql =
...
export const consultingFlowUploadRequestsPendingFingerprintIndexSql = `
...
export const consultingFlowUploadCompletionsTableSql = `
...
export const consultingFlowUploadCompletionsNoUpdateTriggerSql =
...
export const consultingFlowUploadCompletionsNoDeleteTriggerSql =
