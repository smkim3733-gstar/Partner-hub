...
function InputGroupAddon({
  ...
  return (
    // oxlint-disable-next-line jsx-a11y/click-events-have-key-events, jsx-a11y/no-static-element-interactions -- This optional pointer shortcut focuses the existing keyboard-accessible input; nested controls keep their own native interaction.
    <div
