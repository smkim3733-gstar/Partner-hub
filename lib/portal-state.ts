...
import {
  ...
  portalLoginStatsIdentityTriggerSql,
  portalLoginStatsInsertEnvelopeTriggerSql,
  portalLoginStatsTableSql,
  portalLoginStatsUpdateEnvelopeTriggerSql,
...
async function ensurePortalTables(db: D1Database) {
  await db.batch([
    ...
    db.prepare(portalLoginStatsInsertEnvelopeTriggerSql),
    db.prepare(portalLoginStatsIdentityTriggerSql),
    db.prepare(portalLoginStatsUpdateEnvelopeTriggerSql),
